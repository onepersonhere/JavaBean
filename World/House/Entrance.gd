...
var _add_other_characters = false;
...
func add_other_characters(_boolean, _other_character_path, _other_pos_x, _other_pos_y):
	_add_other_characters = _boolean;
	if _boolean:
		self.other_character_path = _other_character_path;
		self.other_pos_x = _other_pos_x;
		self.other_pos_y = _other_pos_y;

func scene_changer(pos_x, pos_y, _entering_area, _entering_area_name, _exit_area_name):
	self.pos_x = pos_x;
	self.pos_y = pos_y;
	self.entering_area = _entering_area;
	self.entering_area_name = _entering_area_name;
	self.exit_area_name = _exit_area_name;
