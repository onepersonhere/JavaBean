...
func _physics_process(delta):
	...
	match state:
		...
		WANDER:
			...
			animationTree.set("parameters/blend_position", direction.normalized())
...
func _on_Stats_no_health():
	queue_free()
	var ghostDeathEffect = DeathEffect.instance()
	get_parent().add_child(ghostDeathEffect)
	ghostDeathEffect.global_position = global_position
